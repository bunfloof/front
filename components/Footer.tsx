...
export function Footer() {
  return (
    <footer
      className="relative -mt-6 w-full rounded-t-3xl border-t border-[#1A77AD]/30"
      style={{
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex items-center justify-center w-9 h-9 rounded-lg bg-[#0D3A54]/50 text-[#7AC2EB]/60 hover:bg-[#00c4aa]/20 hover:text-[#00c4aa] transition-colors duration-200"
                >
                  {social.icon}
                </a>
              ))}
