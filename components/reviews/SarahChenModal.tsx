...
export function SarahChenModal({ isOpen, onClose }: BaseReviewerModalProps) {
  return (
    <ModalWrapper isOpen={isOpen} onClose={onClose}>
      {/* Review text */}
      <p className="text-[#BDE0F5] leading-relaxed text-lg mb-6 pr-8">
        "Switched from another host and the difference is night and day. Zero
        lag, great panel, and the price is unbeatable."
      </p>
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          <span className="font-semibold text-green-50 block">Sarah Chen</span>
      ...
      <div className="pt-4 border-t border-[#1A77AD]/30">
        ...
        <span className="text-sm font-medium text-[#00c4aa]">Discord</span>
      </div>
    </ModalWrapper>
  );
}
