...
export function EmmaRodriguezModal({
  isOpen,
  onClose,
  ...
  return (
    <ModalWrapper isOpen={isOpen} onClose={onClose}>
      ...
      <p className="text-[#BDE0F5] leading-relaxed text-lg mb-6 pr-8">
        "The custom Pterodactyl panel is amazing. So many features that other
        hosts don't offer. Highly recommend!"
      </p>
      ...
      <div className="pt-4 border-t border-[#1A77AD]/30">
        ...
        <span className="text-sm font-medium text-[#00c4aa]">Reddit</span>
      </div>
    </ModalWrapper>
  );
}
