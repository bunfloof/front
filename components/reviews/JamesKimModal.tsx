...
export function JamesKimModal({ isOpen, onClose }: BaseReviewerModalProps) {
  return (
    <ModalWrapper isOpen={isOpen} onClose={onClose}>
      {/* Review text */}
      <p className="text-[#BDE0F5] leading-relaxed text-lg mb-6 pr-8">
        "Support responded in under 5 minutes and solved my issue immediately.
        This is what good hosting looks like."
      </p>
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          <span className="font-semibold text-green-50 block">James Kim</span>
