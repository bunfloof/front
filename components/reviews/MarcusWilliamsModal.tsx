...
export function MarcusWilliamsModal({
  isOpen,
  onClose,
  ...
  return (
    <ModalWrapper isOpen={isOpen} onClose={onClose}>
      ...
      <p className="text-[#BDE0F5] leading-relaxed text-lg mb-6 pr-8">
        "Been with Foxomy for 2 years now. They've never let me down. The uptime
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          ...
          <span className="text-[#BDE0F5]/50 text-sm">September 2024</span>
        </div>
      </div>
