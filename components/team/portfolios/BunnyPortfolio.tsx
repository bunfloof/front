...
export function BunnyPortfolio() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-[#BDE0F5] text-lg leading-relaxed mb-6">
              I'm a furry artist and developer who loves to create and share my
              work with the world. I'm also a big fan of the furry community and
              I'm always looking for new ways to help and support it.
            </p>
