...
export const AsciiNoiseEffect = ({
  ...
  bw = false,
  charset = 1,
  tint = [0.7043955100486045, 0.3, 0.370243954757203],
  distortAmp = 0.02,
  frequency = 10.15,
  zRate = 0.098,
  brightness = 0.89,
  contrast = 0.64,
  seed1 = 9.591535780096237,
  seed2 = 6.7848715940252236,
  hue = 9.8,
  sat = 1.38,
  gamma = 0.97,
  vignette = 0.02,
  vignetteSoftness = 1.06,
  glyphSharpness = 0.158,
  bg = [0.09733901591630309, 0.09215533696194296, 0.010238767085853528],
  className,
