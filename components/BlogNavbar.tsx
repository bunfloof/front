    ...
    <nav className="fixed top-0 inset-x-0 z-50 w-full">
      ...
      {isAtTop && (
        <div className="fixed inset-x-0 top-0 h-12 -z-10 pointer-events-none">
          <div
            ...
            style={{
              background: `linear-gradient(to bottom, var(--blog-nav-bg), transparent)`,
            }}
          />
        </div>
      )}
      ...
      <div className="hidden lg:block w-full">
        <div
          ...
          style={{
            backgroundColor: isAtTop ? "transparent" : "var(--blog-nav-bg)",
            borderColor: isAtTop ? "transparent" : "var(--blog-border)",
                    ...
                    <Link
                      ...
                      onMouseEnter={(e) => {
                        e.currentTarget.style.backgroundColor =
                          "var(--blog-nav-hover)";
                        e.currentTarget.style.color = "var(--blog-heading)";
                      }}
                      onMouseLeave={(e) => {
              ...
              <div className="flex space-x-2 items-center">
                ...
                <div className="relative" ref={loginRef}>
                  <button
                    ...
                    style={{
                      backgroundColor: "var(--blog-button-bg)",
                      borderColor: "var(--blog-button-border)",
                      color: "var(--blog-button-text)",
                    }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.backgroundColor =
                        "var(--blog-button-hover)";
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.backgroundColor =
                        "var(--blog-button-bg)";
                  ...
                  <AnimatePresence>
                    {loginDropdown && (
                      <motion.div
                        ...
                        style={{
                          backgroundColor: "var(--blog-dropdown-bg)",
              ...
              >
                <div className="w-6 h-6 flex flex-col justify-center items-center">
                  <motion.span
                    ...
                    style={{ backgroundColor: "var(--blog-heading)" }}
                  />
                  <motion.span
                    initial={{ opacity: 1 }}
